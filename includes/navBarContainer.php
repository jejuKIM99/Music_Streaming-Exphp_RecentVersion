<div id="navBarContainer">
	<nav class="navBar">
		...
		<div class="group">
			...
			<div class="navItem">
				<span role="link" tabindex="0" onclick="openPage('notification_list.php')" class="navItemLink">Notification
				</span>
			</div>
			...
			<div class="navItem">
				<span role="link" tabindex="0" onclick="openPage('Admin.php')" class="navItemLink">Admin Page
				</span>
			</div>
